...
def init_distributed_mode(args):
    ...
    # Bind this process to its GPU exactly once
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA not available on this rank")
    torch.cuda.set_device(local_rank)

    # Single init (let torchrun provide the rendezvous; no custom dist_url/init_method)
