...
The Jupyter notebooks ([keyfilteranal.ipynb](https://github.com/tonylindeberg/masterfiltmodel/model-fitting/keyfilteranal.ipynb)) and ([keyfilteranal-x1.ipynb](https://github.com/tonylindeberg/masterfiltmodel/model-fitting/keyfilteranal-x1.ipynb)) contain the Python code that was used for :
<ul>
...
The Python file ([filteranal.py](https://github.com/tonylindeberg/masterfiltmodel/model-fitting/filteranal.py)) contains a set of library functions used in the Jupyter notebooks.
<p>
