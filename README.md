...
Z. Liu, H. Mao, C.-Y. Wu, C. Feichtenhofer, T. Darrell and S. Xie (2022), A ConvNet for the 2020s, in ‘Proc. Computer Vision and Pattern Recognition (CVPR 2022)’, pp. 11976–11986.
([OpenAccess](https://openaccess.thecvf.com/content/CVPR2022/papers/Liu_A_ConvNet_for_the_2020s_CVPR_2022_paper.pdf))

S. Woo, S. Debnath, R. Hu, X. Chen, Z. Liu, I. S. Kweon & S. Xie (2023), ConvNeXt V2: Co-designing and scaling ConvNets with masked autoencoders, in ‘Computer Vision and Pattern Recognition (CVPR 2023)’.
